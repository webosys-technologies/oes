  ...
  <div class="container">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <div class=""><a href="#"><span><img src="<?php echo base_url();?>assets/images/delto_logo.PNG" width="100px" hight="100px"></span></a></div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<li id="about"><a href="#we-offer" class="effect-3 page-scroll">About</a></li>
		<li id="services"><a href="#services" class="effect-3 page-scroll">Services</a></li>
		<li id="contact"><a href="#contact" class="effect-3 page-scroll">Contact</a></li>
